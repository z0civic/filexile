namespace FilExile.Dialogs
{
	partial class RobocopyDlg
	{
		...
		private void InitializeComponent()
		{
			...
			// chk_AlwaysIgnore
			// 
			this.chk_AlwaysIgnore.AutoSize = true;
			this.chk_AlwaysIgnore.Checked = global::FilExile.Properties.Settings.Default.disableRobocopyCheck;
			this.chk_AlwaysIgnore.DataBindings.Add(new System.Windows.Forms.Binding("Checked", global::FilExile.Properties.Settings.Default, "disableRobocopyCheck", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
			this.chk_AlwaysIgnore.Location = new System.Drawing.Point(69, 152);
			this.chk_AlwaysIgnore.Name = "chk_AlwaysIgnore";
			this.chk_AlwaysIgnore.Size = new System.Drawing.Size(134, 17);
			this.chk_AlwaysIgnore.TabIndex = 5;
			this.chk_AlwaysIgnore.Text = "&Always ignore this error";
			this.chk_AlwaysIgnore.UseVisualStyleBackColor = true;
			// 
			// RobocopyDlg
			// 
			...
			this.Text = "Error";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.RobocopyDlg_FormClosing);
